                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <d:choose>
                                        <d:when test="${not empty productSalesByOperatorList}">
                                            <d:forEach var="productSalesByOperatorValue" items="${productSalesByOperatorList}">
                                                <d:set var="count" value="${count+1}" />
                                                <tr class="odd gradeC">
                                                    <td>${productSalesByOperatorValue.product}</td>
                                                    <td>${productSalesByOperatorValue.QTY}</td>
                                                    <td>${productSalesByOperatorValue.unitPrice}</td>
                                                    <td>${productSalesByOperatorValue.gross}</td>
                                                </tr>
                                            </d:forEach>
                                        </d:when>
                                    </d:choose>
